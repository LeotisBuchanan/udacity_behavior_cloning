...
with open(data) as csvfile:
    ...
    #next(reader)
    for line in reader:
        line[0] = line[0].replace('/Users/yardman/development/data/', "")
        line[1] = line[1].replace('/Users/yardman/development/data/', "")
        line[2] = line[2].replace('/Users/yardman/development/data/', "")
