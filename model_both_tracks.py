...
with open("data_both_tracks/driving_log_path_fixed.csv") as csvfile:
...
for line in lines:
    ...
    current_path = "data_both_tracks/IMG/" + filename
...
import pickle
with open('data_both_tracks.pickle','wb') as f:
...
model.save('model_both_tracks.h5')  # save model to .h5 file, including architechture, weights, loss, optimizer
